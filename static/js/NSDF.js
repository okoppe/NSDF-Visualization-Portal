...
//function that changes file that is downloaded based on which data set is selected.
{
  ...
  if (x=="foam slice")
  {
    url = '/Users/owenkoppe/Desktop/flask_nsdf_1/static/downloads/demo_slice_foam_dataset_from_cloud_sources.py'//needs to be fixed
    window.open(url)
  }
  if (x=="3D Rabbit")
  {
...
function inline()
//function to view the data set inline
{
  //not yet implemented
}
